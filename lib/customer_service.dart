...
class CustomerService {
  ...
  static Future<List<Customer>> httpGetResponse(String apiURI) async {
    ...
    final http.Response response = await http.get(Uri.parse(serverAddress + apiURI), headers: headers);
  ...
  static Future<void> retrieveCookie() async {
    // SharedPreferences prefs = await SharedPreferences.getInstance();
    // var jwtAuthToken = {"Cookie":prefs.getString('tokenType') + " " + prefs.getString('accessToken')};
